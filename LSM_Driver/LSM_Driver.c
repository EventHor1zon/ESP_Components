...
const parameter_t lsm_parameter_map[lsm_param_map_len] = {
    ...
    {"Op Mode", 7, &LSM_getOpMode, &LSM_setOpMode, NULL, DATATYPE_UINT8, LSM_OPMODE_GYRO_ACCEL, (GET_FLAG | SET_FLAG)},
    {"Accel ODR", 8, &LSM_getAccelODRMode, &LSM_setAccelODRMode, NULL, DATATYPE_UINT8, LSM_ACCODR_6_66KHZ, (GET_FLAG | SET_FLAG)},
    {"Gyro ODR", 9, &LSM_getGyroODRMode, &LSM_setGyroODRMode, NULL, DATATYPE_UINT8, LSM_GYRO_ODR_1_66KHZ, (GET_FLAG | SET_FLAG)},
    {"Accel Fullscale", 10, &LSM_get_accel_full_scale, &LSM_set_accel_full_scale, NULL, DATATYPE_UINT8, LSM_ACCSCALE_8G, (GET_FLAG | SET_FLAG)},
    {"Gyro Fullscale", 11, &LSM_get_gyro_full_scale, &LSM_set_gyro_full_scale, NULL, DATATYPE_UINT8, LSM_GYRO_SCALE_125DPS, (GET_FLAG | SET_FLAG)},
    {"Accel BW mode", 12, &LSM_get_accel_bw_select_mode, &LSM_set_accel_bw_select_mode, NULL, DATATYPE_UINT8, LSM_ACC_BW_FROM_REG, (GET_FLAG | SET_FLAG)},
    {"Gyro Sleep", 13, &LSM_get_gyro_sleep_state, &LSM_set_gyro_sleep_state, NULL, DATATYPE_UINT8, LSM_GYRO_SLEEP_ENABLED, (GET_FLAG | SET_FLAG)},
    {"Merge Interrupts", 14, &LSM_get_int2_on_int1_state, &LSM_set_int2_on_int1_state, NULL, DATATYPE_UINT8, 1, (GET_FLAG | SET_FLAG)},
    {"Temp pkt en", 15, &LSM_get_temperature_pkt_en, &LSM_set_temperature_pkt_en, NULL, DATATYPE_BOOL, 1, (GET_FLAG | SET_FLAG)},
    {"Threshold stop", 16, &LSM_get_stop_on_fifo_thresh, &LSM_set_stop_on_fifo_thresh, NULL, DATATYPE_BOOL, 1, (GET_FLAG | SET_FLAG)},
    {"Gyro HighPower", 17, &LSM_get_gyro_hp_mode, &LSM_set_gyro_hp_mode, NULL, DATATYPE_BOOL, 1, (GET_FLAG | SET_FLAG)},
    {"G HPass mode", 18, &LSM_get_gyro_hpfilter_mode, &LSM_get_gyro_hpfilter_mode, NULL, DATATYPE_BOOL, 1, (GET_FLAG | SET_FLAG)},
    {"G HPass Cutoff", 19, &LSM_get_gyro_hp_filter_cutoff, &LSM_set_gyro_hp_filter_cutoff, NULL, DATATYPE_UINT8, LSM_GYRO_HPCUTOFF_16_3HZ, (GET_FLAG | SET_FLAG)},
    {"A LPass2 en", 20, &LSM_get_accel_lp2_filter_en, &LSM_set_accel_lp2_filter_en, NULL, DATATYPE_BOOL, 1, (GET_FLAG | SET_FLAG)},
    {"A HPass Cutoff", 21, &LSM_get_accel_hpfilter_mode, &LSM_set_accel_hpfilter_mode, NULL, DATATYPE_BOOL, 1, (GET_FLAG | SET_FLAG)},
    {"A HPass mode", 22, &LSM_get_accel_hp_filter_cutoff, &LSM_set_accel_hp_filter_cutoff, NULL, DATATYPE_BOOL, 1, (GET_FLAG | SET_FLAG)},
    {"6D LPass en", 23, &LSM_get_lowpass_on_6d_mode, &LSM_set_lowpass_on_6d_mode, NULL, DATATYPE_BOOL, 1, (GET_FLAG | SET_FLAG)},
    {"Adv Func en", 24, &LSM_get_function_en, &LSM_set_function_en, NULL, DATATYPE_BOOL, 1, (GET_FLAG | SET_FLAG)},
    {"A HPass Cutoff", 25, &LSM_get_accel_hp_filter_cutoff, &LSM_set_accel_hp_filter_cutoff, NULL, DATATYPE_BOOL, LSM_OPMODE_GYRO_ACCEL, (GET_FLAG | SET_FLAG)},
    ...
    {"Intr1 Triggers", 29, NULL, &LSM_set_interrupt_1, NULL, DATATYPE_UINT8, UINT8_MAX, (GET_FLAG | SET_FLAG)},
    {"Intr2 Triggers", 30, NULL, &LSM_set_interrupt_2, NULL, DATATYPE_UINT8, UINT8_MAX, (GET_FLAG | SET_FLAG)},
    {"Gyro Fullscale", 31, &LSM_get_gyro_full_scale, &LSM_set_gyro_full_scale, NULL, DATATYPE_UINT8, LSM_GYRO_SCALE_125DPS, (GET_FLAG | SET_FLAG)},
    {"BDU en", 32, &LSM_get_block_data_update_en, &LSM_set_block_data_update_en, NULL, DATATYPE_BOOL, 1, (GET_FLAG | SET_FLAG) },
    {"MSB only en", 33, &LSM_get_only_msb_data, &LSM_set_only_msb_data, NULL, DATATYPE_BOOL, 1, (GET_FLAG | SET_FLAG) },
    {"Step Pkt en", 34, &LSM_get_fifo_step_en, &LSM_set_fifo_step_en, NULL, DATATYPE_BOOL, 1, (GET_FLAG | SET_FLAG) },
    {"Step DRDY", 35, &LSM_get_fifo_step_drdy, &LSM_set_fifo_step_drdy, NULL, DATATYPE_UINT8, 1, (GET_FLAG | SET_FLAG) },
    {"Fido ODR", 36, &LSM_get_fifo_odr, &LSM_set_fifo_odr, NULL, DATATYPE_UINT8, LSM_GYRO_ODR_1_66KHZ, (GET_FLAG | SET_FLAG) },
    {"Fifo Mode", 37, &LSM_get_fifo_mode, &LSM_set_fifo_mode, NULL, DATATYPE_UINT8, LSM_FIFO_MODE_CONTINUOUS, (GET_FLAG | SET_FLAG) },
    {"Fifo Threshold", 38, &LSM_get_fifo_watermark, &LSM_set_fifo_watermark, NULL, DATATYPE_UINT16, LSM_WATERMARK_MAX, (GET_FLAG | SET_FLAG) },
};
